...
public class CustomMessageConverter implements MessageConverter {
    ...
    public Message toMessage(Object object, Session session) throws JMSException, MessageConversionException {
        if (!(object instanceof com.wallet.service.model.Message)) {
            throw new IllegalArgumentException("Expected instance of com.litres.bookstore.model.Message");
        }
    
        com.wallet.service.model.Message myMessage = (com.wallet.service.model.Message) object;
        try {
    ...
    public Object fromMessage(Message message) throws JMSException, MessageConversionException {
        ...
        com.wallet.service.model.Message myMessage = null;
        try {
            myMessage = mapper.readValue(payload, com.wallet.service.model.Message.class);
        } catch (Exception e) {
