...
import com.service.schedule.config.AutoWiringSpringBeanJobFactory;
...
public class QrtzScheduler {
    ...
    public JobDetail jobDetail() {
        ...
        return newJob().ofType(BasicJob.class).storeDurably().withIdentity(JobKey.jobKey("Qrtz_Job_Detail")).withDescription("Invoke Sample Job service...").build();
    }
